...
---
## About
- Computer Science & Engineering undergraduate at Nirma University
- Interested in Backend Engineering, AI Systems, and Cloud Technologies
- Building products across AI, automation, developer tooling, and web platforms
- 30+ accepted open-source contributions
- Hackathon winner and active builder
...
![RAG](https://img.shields.io/badge/RAG-Systems-blue?style=flat)
...
- Every project begins with "this should be simple."
- If it works in production, it was definitely planned that way.
---
## Reach Out
